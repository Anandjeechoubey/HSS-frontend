    ...
    <>
      ...
      <section className="padded-container d-flex align-items-center flex-wrap flex-md-nowrap">
        <div>
          ...
          <p className="section-content">
            This laboratory has been created at the Department of HSS as a
            modest facility to conduct research and give training to the
            students and faculty. It was established in the year 1971 with the
            objective of providing theoretical and practical understanding of
            behavioral aspects of an individual as well as of the group.
          </p>
          <Button variant="outline-primary" href="#">
            View More
          </Button>
